...
export const footerNav: { title: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { label: 'Urology', href: '/centres/urology/' },
      { label: 'Orthopaedics & MSK', href: '/centres/msk-orthopaedics/' },
      { label: 'Rheumatology', href: '/centres/rheumatology/' },
      { label: 'Heart Health', href: '/centres/heart-health/' },
      { label: 'Endocrinology', href: '/centres/endocrinology/' },
      { label: 'Imaging & Diagnostics', href: '/centres/imaging-diagnostics/' },
      { label: 'Weight Management', href: '/centres/weight-management/' },
      { label: 'Private GP', href: '/centres/private-gp/' },
    ],
  },
  {
    title: 'Visit',
